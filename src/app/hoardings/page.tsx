...
//                     <Link href={`/hoardings/${location.id}`}>
//                       <div className="relative overflow-hidden">
//                         <Image
//                           src={
//                             location.image ||
...
import { useState, useEffect } from "react"
import Head from "next/head"
import { Search, Filter, MapPin, Users, ArrowRight, Sparkles, Eye, Globe, BarChart3 } from "lucide-react"
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-0 left-0 w-full h-full opacity-[0.03]">
            <svg width="100%" height="100%" viewBox="0 0 1200 800" className="animate-pulse">
              <defs>
                <pattern id="wave1" x="0" y="0" width="300" height="150" patternUnits="userSpaceOnUse">
                  <path
                    d="M0,75 Q75,25 150,75 T300,75"
                    stroke="rgb(59, 130, 246)"
                    strokeWidth="3"
                ...
                <pattern id="wave2" x="0" y="0" width="200" height="100" patternUnits="userSpaceOnUse">
                  <path
                    d="M0,50 Q50,10 100,50 T200,50"
                    stroke="rgb(99, 102, 241)"
                    strokeWidth="2"
                ...
                <pattern id="wave3" x="0" y="0" width="250" height="120" patternUnits="userSpaceOnUse">
                  <path
                    d="M0,60 Q62.5,20 125,60 T250,60"
                    stroke="rgb(139, 92, 246)"
                    strokeWidth="2"
              ...
              <rect width="100%" height="100%" fill="url(#wave1)" />
              <rect width="100%" height="100%" fill="url(#wave2)" transform="translate(100, 50)" />
              <rect width="100%" height="100%" fill="url(#wave3)" transform="translate(50, 100)" />
            </svg>
          </div>
        </div>
        ...
        <div className="relative z-10 py-12 pt-36">
          ...
          >
            <div className="inline-flex items-center gap-4 glass-professional px-8 py-4 rounded-full subtle-glow mb-10">
              ...
              <span className="text-sm font-semibold text-slate-700 tracking-wide">PREMIUM BILLBOARD NETWORK</span>
              <div className="w-2 h-2 bg-gradient-to-r from-indigo-400 to-slate-400 rounded-full animate-pulse"></div>
            </div>
            <h1 className="text-6xl md:text-8xl font-bold bg-gradient-to-r from-slate-600 via-slate-700 to-slate-600 bg-clip-text text-transparent mb-8 leading-tight tracking-tight">
              Strategic
            ...
            <p className="text-slate-600 max-w-4xl mx-auto text-xl leading-relaxed font-medium">
              Discover strategically positioned billboard locations in high-impact markets.
              <span className="text-indigo-600 font-semibold"> Maximize your brand&apos;s market penetration</span> with
              our curated portfolio of premium advertising real estate.
            </p>
          </div>

          {/* MOBILE OPTIMIZED Professional Search Section */}
          <div
            className={`max-w-6xl mx-auto px-4 mb-20 transition-all duration-1200 delay-300 ${isVisible ? "animate-fade-in-up" : "opacity-0"}`}
          >
            <div className="glass-professional rounded-2xl sm:rounded-3xl p-4 sm:p-6 lg:p-10 professional-glow">
              <div className="flex flex-col gap-4 sm:gap-6 lg:flex-row lg:gap-8">
                {/* MOBILE OPTIMIZED Professional Search Bar */}
                <div className="relative flex-1">
                  <div className="absolute left-3 sm:left-4 lg:left-6 top-1/2 transform -translate-y-1/2 text-indigo-500">
                    <Search className="w-5 h-5 sm:w-6 sm:h-6" />
                  </div>
                  <input
                    type="text"
                    placeholder="Search locations, markets..."
                    value={searchTerm}
                    onChange={(e) => setSearchTerm(e.target.value)}
                    className="w-full pl-12 sm:pl-14 lg:pl-16 pr-12 sm:pr-14 lg:pr-6 py-3 sm:py-4 lg:py-5 bg-white/80 border-2 border-slate-200 rounded-xl sm:rounded-2xl focus:outline-none focus:ring-4 focus:ring-indigo-500/20 focus:border-indigo-500/50 transition-all duration-300 placeholder-slate-400 text-slate-700 font-medium text-sm sm:text-base lg:text-lg backdrop-blur-sm"
                  />
                  <div className="absolute right-3 sm:right-4 lg:right-6 top-1/2 transform -translate-y-1/2">
                    <div className="w-8 h-8 sm:w-9 sm:h-9 lg:w-10 lg:h-10 bg-gradient-to-r from-indigo-600 to-indigo-500 rounded-full flex items-center justify-center">
                      <BarChart3 className="w-4 h-4 sm:w-5 sm:h-5 text-white" />
                    </div>
                  </div>
                </div>

                {/* MOBILE OPTIMIZED Professional Filter Button */}
                <button className="flex items-center justify-center gap-2 sm:gap-3 lg:gap-4 px-6 sm:px-8 lg:px-10 py-3 sm:py-4 lg:py-5 bg-gradient-to-r from-emerald-600 to-teal-700 text-white rounded-xl sm:rounded-2xl transition-all duration-300 subtle-glow font-semibold text-sm sm:text-base lg:text-lg hover:from-emerald-700 hover:to-teal-800 active:scale-95 touch-manipulation">
                ...
                >
                  <div className="glass-card relative w-full h-auto transition-all duration-700 overflow-hidden rounded-3xl">
                    ...
                    <div className="p-8">
                      ...
                      <h3 className="text-2xl font-bold mb-4">
                        <Link href={`/hoardings/${location.id}`}>
                          <span className="text-slate-700 transition-all duration-300">{location.name}</span>
                        </Link>
                      </h3>
                      ...
                      {/* Description */}
                      <p className="text-slate-600 text-sm leading-relaxed line-clamp-3 mb-6">{location.description}</p>
                      ...
                      <div className="grid grid-cols-2 gap-4 mb-6">
                        <div className="bg-gradient-to-br from-blue-50 to-indigo-50 p-4 rounded-xl border border-blue-200/50">
                          ...
                          <div className="text-slate-700 font-bold text-lg">{formatTraffic(location.dailyTraffic)}</div>
                          <div className="text-xs text-slate-500 mt-1">impressions/day</div>
                        </div>
                        <div className="bg-gradient-to-br from-emerald-50 to-teal-50 p-4 rounded-xl border border-emerald-200/50">
                          <div className="flex items-center gap-2 text-xs text-emerald-600 font-semibold mb-2">
                            <Users className="w-4 h-4" />
                          ...
                          <div className="text-slate-700 font-bold text-lg">{location.numberOfBoards} boards</div>
                          <div className="text-xs text-slate-500 mt-1">premium locations</div>
                        </div>
                      </div>
          ...
          {filteredLocations.length === 0 && (
            <div className="text-center py-24">
              ...
              <h3 className="text-4xl font-bold text-slate-700 mb-6">No locations match your criteria</h3>
              <p className="text-slate-500 mb-10 text-lg max-w-2xl mx-auto">
                Refine your search parameters or explore our complete portfolio of premium advertising locations
              </p>
              <button
                onClick={() => setSearchTerm("")}
                className="bg-gradient-to-r from-purple-600 to-violet-700 text-white px-10 py-4 rounded-2xl font-semibold transition-all duration-300 subtle-glow"
            ...
            <div className="glass-professional rounded-[32px] p-10 professional-glow overflow-hidden relative">
              ...
              <div className="flex flex-col md:flex-row items-center gap-8 relative z-10">
                ...
                <div className="md:w-2/3 text-left">
                  ...
                  <p className="text-slate-600 mb-6 text-lg leading-relaxed">
                    Partner with industry leaders to execute high-impact advertising campaigns across our premium
                    billboard network.
                    <span className="font-semibold text-indigo-600"> Drive measurable results</span> and establish
                    market dominance.
                  </p>
                </div>
                {/* Right buttons */}
