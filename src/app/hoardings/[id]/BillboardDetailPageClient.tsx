...
export default function BillboardDetailPageClient({ params, board }: BillboardDetailPageProps) {
  ...
  const toggleModalImageFit = () => {
    setModalImageFit((prev) => (prev === "contain" ? "cover" : "contain"))
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
      ...
      {/* Media Gallery Section - Moved to Top */}
      <section
        className={`bg-white shadow-sm border-b border-gray-200 transition-all duration-1000 ${
        ...
        <div className="container mx-auto px-4 py-8">
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="flex items-center gap-4">
              ...
              >
                {imageFit === "cover" ? <Minimize className="w-4 h-4" /> : <Expand className="w-4 h-4" />}
                {imageFit === "cover" ? "Fit to View" : "Fill Frame"}
              </button>
              <div className="flex items-center gap-2 text-sm text-gray-500">
                <span>
                  {currentImageIndex + 1} of {allImages.length}
          ...
          <div className="relative group">
            {/* Main Image Display */}
            <div
              className={`relative ${imageFit === "contain" ? "h-auto max-h-[600px]" : "h-96 md:h-[500px]"} rounded-2xl overflow-hidden shadow-lg bg-gray-100 flex items-center justify-center`}
            >
              <img
                src={
                  allImages[currentImageIndex] ||
                ...
                alt={`${board.name} view ${currentImageIndex + 1}`}
                className={`${imageFit === "contain" ? "max-w-full max-h-full object-contain" : "w-full h-full object-cover"} transition-all duration-500 hover:scale-105 cursor-pointer`}
                onClick={() => openModal(currentImageIndex)}
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/20 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
      ...
      {/* Image Modal */}
      {isModalOpen && (
        <div className="fixed inset-0 bg-black/95 z-50 flex items-center justify-center p-4 animate-slide-in">
          <div className="relative w-full h-full flex items-center justify-center">
            ...
            <button
              onClick={toggleModalImageFit}
              className="absolute top-4 left-4 bg-white/20 hover:bg-white/30 text-white px-4 py-2 rounded-lg font-medium transition-all duration-300 z-10 flex items-center gap-2"
            >
              {modalImageFit === "contain" ? <Expand className="w-4 h-4" /> : <Minimize className="w-4 h-4" />}
              {modalImageFit === "contain" ? "Fill Screen" : "Fit Screen"}
            </button>
            ...
            <div className="w-full h-full flex items-center justify-center">
              <img
                src={allImages[modalImageIndex] || "/placeholder.svg"}
                alt={`${board.name} full size view`}
                className={`${modalImageFit === "contain" ? "max-w-full max-h-full object-contain" : "w-full h-full object-cover"} rounded-lg`}
              />
            </div>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
          ...
          <div className="xl:col-span-1 space-y-8">
            ...
            {/* Call to Action */}
            <section
              className={`bg-gradient-to-br from-blue-500 to-indigo-600 rounded-2xl shadow-lg overflow-hidden transition-all duration-1000 ${
                isVisible ? "animate-fade-in-up stagger-6" : "opacity-0"
              }`}
            >
              <div className="p-6 text-white">
                <div className="flex items-center gap-3 mb-4">
